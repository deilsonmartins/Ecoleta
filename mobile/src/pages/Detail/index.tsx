...
{
  Linking.openURL(`whatsapp://send?phone=${data.point.whatsaap}&text=Tenho interesse sobre a coleta de resíduos`);
}
  if (!data.point)
  {
    return null;
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <View style={styles.address}>
            ...
            <Text style={styles.addressContent}>{data.point.city.toLocaleUpperCase()} / {data.point.uf.toLocaleUpperCase()}</Text>
      </View>
    </View>
